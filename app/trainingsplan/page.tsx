...
style={{
minHeight: "100vh",
background: "radial-gradient(circle at top, #050505ff)", // EXTREM DUNKEL
...
background: "linear-gradient(90deg, #000000ff 100%)",
color: "#facc15",
cursor: "pointer",
...
width: '100%',
maxWidth: '800px',
// FIX: Auch hier extrem dunkler Hintergrund, aber mit einem Hauch von Grauschwarz
